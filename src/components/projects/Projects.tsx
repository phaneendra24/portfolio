                    ...
                    allprojects.map(i=>{
                        return(
                            ...
                            <div className="w-full sm:w-2/3 flex  gap-2 justify-between order-2 flex-col ">
                                ...
                                <h1 className="p-1 bg-blue-700 w-fit">
                                stack
                                </h1>
                                ...
                                <div className="flex justify-evenly">
                                    ...
                                    <a href={`https://${i.repo}`} target="_blank" className="flex justify-center items-center hover:scale-105 p-2 bg-[#282a36] rounded-md">
                                    ...
                                    <a href={`https://${i.livesite}`} target="_blank" className="flex justify-center items-center hover:scale-105 p-2 bg-[#282a36] rounded-md">
